class EventDetailResponseModel {
  ...
  EventDetailResponseModel.fromJson(Map<String, dynamic> json) {
...
//   List<EventViewItems>? eventItems;
  ...
  EventDetailData(
      ...
      this.eventItems,
      this.vendor,
      this.eventmultipleDetail});

  EventDetailData.fromJson(Map<String, dynamic> json) {
    if (json['order_detail'] != null) {
      eventDetail = <EventViewDetail>[];
      json['order_detail'].forEach((v) {
        eventDetail!.add(new EventViewDetail.fromJson(v));
      });
    }
    if (json['order_items'] != null) {
      eventItems = <EventViewItems>[];
      json['order_items'].forEach((v) {
        eventItems!.add(new EventViewItems.fromJson(v));
      });
    }
    if (json['vendor'] != null) {
      vendor = <Vendor>[];
    ...
    if (json['multiple_order_detail'] != null) {
      eventmultipleDetail = <EventMultipleDetail>[];
      json['multiple_order_detail'].forEach((v) {
        eventmultipleDetail!.add(new EventMultipleDetail.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.eventDetail != null) {
      data['order_detail'] = this.eventDetail!.map((v) => v.toJson()).toList();
    }
    if (this.eventItems != null) {
      data['order_items'] = this.eventItems!.map((v) => v.toJson()).toList();
    }
    if (this.vendor != null) {
      data['vendor'] = this.vendor!.map((v) => v.toJson()).toList();
    }
    if (this.eventmultipleDetail != null) {
      data['multiple_order_detail'] =
          this.eventmultipleDetail!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class EventViewDetail {
  ...
  EventViewDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
...
class EventViewItems {
  ...
  EventViewItems.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    vendorId = json['vendor_id'];
...
class EventMultipleDetail {
  ...
  EventMultipleDetail.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    orderId = json['order_id'];
    ticketId = json['ticket_id'];
    ticketuseStatus = json['ticketuse_status'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ticketuse_status'] = this.ticketuseStatus;
    data['ticket_qrcode'] = this.ticketQrcode;
    data['ticket_pdf'] = this.ticketPdf;
    data['created_at'] = this.createdAt;
    return data;
  }
}
...
//   List<Vendor>? vendor;
//
//   EventDetailData({this.eventDetail, this.eventItems, this.vendor});
//
//   EventDetailData.fromJson(Map<String, dynamic> json) {
//     if (json['order_detail'] != null) {
//       eventDetail = <EventViewDetail>[];
